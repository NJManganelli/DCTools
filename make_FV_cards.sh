...
python make_card.py --name WZfid --input ./config/inc-WZ/input_UL_2018-WZ_inclusive.yaml    --era 2018    --mode fiducial --channel inc-SR01 -rrt datadriven -v dilep_tau_loose_met_hadron_mt
